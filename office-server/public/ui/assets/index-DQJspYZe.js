            ...
            (0, k.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, k.jsxs)(`button`, {
                  ...
                  children: [
                    (0, k.jsx)(`span`, { style: { fontSize: `16px` }, children: `⚡` }),
                    ` Bypass Permissions`,
                  ],
                }),
              ],
...
function Ft(e) {
  ...
  return (
    console.log(
      `✓ Built dynamic catalog with ${t.length} assets (${l.length} visible, ${u} rotation groups, ${Ot.size / 2} state pairs, ${d} animation groups)`,
    ),
    !0
  );
}
